...
declare-option -hidden str python_bridge_in "%opt{python_bridge_folder}/in"
declare-option -hidden str python_bridge_out "%opt{python_bridge_folder}/out"
declare-option -hidden str python_bridge_fifo "%opt{python_bridge_folder}/fifo"
declare-option -hidden str python_bridge_source %sh{echo "${kak_source%/*}"}
